...
public class ModelRegister {
	// Map maintaining copies of existing SystemUserModel objects mapped using their
	// Unique IDs
	private Map<String, SystemUserModel> modelRegister = new HashMap<String, SystemUserModel>();
	
	// Map maintaining copies of existing CourseOffering objects mapped using their
	// Unique IDs
	private Map<String, CourseOffering> courseRegister = new HashMap<String, CourseOffering>();
	private Map<Integer, LoggedInAuthenticatedUser> loggedInRegister = new HashMap<Integer, LoggedInAuthenticatedUser>();
	...
	public void registerLoggedInUser(Integer ID, LoggedInAuthenticatedUser lu) {
	...
	public LoggedInAuthenticatedUser getLoggedInUser(Integer ID) {
